...
In this section, we present the molecules generated by HIL-DD for six preferences, namely, 
Vina score, bond angle, benzene ring, bond length, dihedral angle deviation,
avoiding large ring. Meanwhile, we provide the molecules generated by ERFM with 
the same noise which are used to generate these molecules by HIL-DD. These examples
demonstrate that HIL-DD can capture human preferences well.
<p align="center">
  <img src="figures/mol-vis.png" width="800" height="800">
</p>
<p align="center">
  <img src="figures/mol-visualization2.png" width="800" height="800">
</p>
