...
# def get_batch_connectivity_matrix(batch_data):
#     batch_ligand_size = torch_scatter.segment_coo(
#         torch.ones_like(batch_data.ligand_element_batch),
#         batch_data.ligand_element_batch,
#         reduce='sum',
#     )
...
#         start_index, end_index = batch_data.ligand_bond_index[:, batch_data.ligand_bond_type_batch == batch_index]
#         start_index -= batch_index_offset[batch_index]
#         end_index -= batch_index_offset[batch_index]
#         bond_type = batch_data.ligand_bond_type[batch_data.ligand_bond_type_batch == batch_index]
